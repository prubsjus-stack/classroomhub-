...
export default function ChatHeader() {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute -right-8 top-full mt-2 w-72 sm:w-96 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden animate-fade-in z-50 flex flex-col" style={{ height: '460px' }}>
          {!chatUser ? (
            <>
