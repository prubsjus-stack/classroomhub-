...
export default function HelpButton({ open, onOpenChange }: HelpButtonProps) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end justify-center p-4 pb-0" onClick={() => onOpenChange(false)}>
          ...
          >
            ...
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold dark:text-white mb-6">Â¿Necesitas ayuda?</h2>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">TelÃ©fono</p>
